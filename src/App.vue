  ...
  <header class="bg-orange-500">
        <nav class="container relative flex items-center justify-between px-6 py-8 mx-auto text-white">
            ...
            <div :class="[open ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
                class="absolute inset-x-0 z-30 w-full px-6 py-8 mt-4 space-y-6 transition-all duration-300 ease-in-out bg-orange-600 top-16 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:space-y-0 md:-mx-6 md:flex md:items-center">
                <a href="#" class="block text-white transition-colors duration-300 md:px-6 hover:text-orange-300">Home</a>
                <a href="#" class="block text-white transition-colors duration-300 md:px-6 hover:text-orange-300"> About
                </a>
                <a href="#" class="block text-white transition-colors duration-300 md:px-6 hover:text-orange-300"> Portfolio
                </a>
                <a href="#" class="block text-white transition-colors duration-300 md:px-6 hover:text-orange-300"> Blogs
                </a>
                <a href="#" class="block text-white transition-colors duration-300 md:px-6 hover:text-orange-300"> Contact
                </a>
            </div>
        </nav>
    </header>
    ...
    <main>
        ...
        <section class="container px-6 py-8 mx-auto lg:py-16 " id="about">
            <div class="lg:flex lg:items-center lg:-mx-4">
                <div class="lg:w-1/2 lg:px-4">
                    ...
                    <button class="flex items-center mt-8 -mx-2 text-orange-500">
        ...
        <section class="container px-6 py-8 mx-auto lg:py-16">
            ...
            <div class="flex items-center py-6 mt-4 -mx-2 overflow-x-auto whitespace-nowrap">
                <button
                    class=" inline-flex px-4 mx-2 focus:outline-none  items-center py-0.5 text-white bg-orange-500 hover:bg-orange-400 duration-300 transition-colors rounded-2xl">All</button>
                <button
                    class=" inline-flex px-4 mx-2 duration-300 transition-colors hover:bg-orange-500/70 hover:text-white text-gray-500 focus:outline-none py-0.5 cursor-pointer rounded-2xl">Web
                    Design</button>
                <button
                    class=" inline-flex px-4 mx-2 duration-300 transition-colors hover:bg-orange-500/70 hover:text-white text-gray-500 focus:outline-none py-0.5 cursor-pointer rounded-2xl">Development</button>
                <button
                    class=" inline-flex px-4 mx-2 duration-300 transition-colors hover:bg-orange-500/70 hover:text-white text-gray-500 focus:outline-none py-0.5 cursor-pointer rounded-2xl">Research</button>
            </div>
    ...
    <footer class="flex flex-col items-center py-20 text-white bg-gray-900">
        <p class="text-center">Copyright © 2023, Tailwind Vue 3 Vite.</p>
